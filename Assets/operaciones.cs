...
public class operaciones : MonoBehaviour {
    ...
    private int operacion, inicio, puntaje;
    private float respuesta;
    private string simbolo;

    private Text txt_operacion, op1,op2,op3,op4, contador;
    ...
    {   
        ...
        puntaje+=5;
        contador.text = "Puntaje: " + puntaje.ToString();
    ...
    {   
        if(inicio>=1){
            ...
            inicio--;
            Debug.Log("Finalizo el Juego - Perdiste");
